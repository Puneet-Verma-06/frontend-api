...
export default function AuthSection() {
  ...
  return (
    <div className=" mt-16 flex flex-col md:flex-row max-w-6xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden my-10 border border-gray-100">
      {/* LEFT */}
      <div className="w-full md:w-1/2 p-8 flex flex-col items-center border-b md:border-b-0 md:border-r border-gray-100">
        <img src="/atithya_logo.jpg" alt="atithya_logo" className="h-10 mb-4" />
          ...
          {videos.map((v, i) => (
            ...
            >
              ...
              <div className="text-center text-xs text-gray-600 py-2">
                {["Adventure", "Explore", "Culture", "Fun"][i]}
              </div>
            </div>
          ))}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {method === "mobile" && (
              ...
              >
                <div className="flex items-center border border-gray-300 rounded-md overflow-hidden">
                  <span className="px-3 text-gray-700 border-r border-gray-200 flex items-center gap-1">
                    🇮🇳 +91
                  </span>
                  <input
                    type="tel"
          ...
          <label className="flex items-start text-sm text-gray-600 gap-2">
            ...
            <span>
              ...
              <a href="#" className="font-semibold text-[#f5b300]">
                Privacy Policy
              </a>{" "}
              and{" "}
              <a href="#" className="font-semibold text-[#f5b300]">
